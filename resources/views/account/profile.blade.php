                ...
                <div class="card-body">
                    ...
                    <form class="">
                        <div class="position-relative row form-group">
                            ...
                            <div class="col-sm-10">
                            <input name="text" id="firstname" placeholder="" type="texr" class="form-control" value="{{Auth::user()->firstname}}">
                            </div>
                        </div>
                        <div class="position-relative row form-group">
                            <label for="lastname" class="col-sm-2 col-form-label">Last Name</label>
                            <div class="col-sm-10">
                                <input name="text" id="lastname" placeholder="" type="texr" class="form-control" value="{{Auth::user()->lastname}}">
                            </div>
                        </div>
                        <div class="position-relative row form-group">
                            <label for="exampleEmail" class="col-sm-2 col-form-label">Email</label>
                            <div class="col-sm-10">
                                <input name="email" id="exampleEmail" placeholder="" type="email" class="form-control" value="{{Auth::user()->email}}">
                            </div>
                        </div>
                        <div class="position-relative row form-group">
